      ...
      <StyleUserInterfaceWrapperBar onClick={props.onCLick}>
        ...
        >
          <svg
            ...
            fill="none"
          >
            <path d="M14.6198 1.93606C12.9917 1.02131 11.0083 1.02131 9.38018 1.93606L3.34356 5.32762C1.88548 6.14682 1.88548 8.25428 3.34356 9.07348L9.38018 12.465C11.0083 13.3798 12.9917 13.3798 14.6198 12.465L20.6564 9.07348C22.1145 8.25428 22.1145 6.14682 20.6564 5.32762L14.6198 1.93606Z" />
            <path d="M2.97517 15.337C1.89805 16.277 2.02084 18.0803 3.34356 18.8235L9.38018 22.215C11.0083 23.1298 12.9917 23.1298 14.6198 22.215L20.6564 18.8235C21.9792 18.0803 22.102 16.277 21.0248 15.337L15.3545 18.5228C13.2701 19.6939 10.7299 19.6939 8.64545 18.5228L2.97517 15.337Z" />
            <path d="M2.81218 10.4955C1.91468 11.4675 2.0918 13.1202 3.34356 13.8235L9.38018 17.2151C11.0083 18.1298 12.9917 18.1298 14.6198 17.2151L20.6564 13.8235C21.9082 13.1202 22.0853 11.4675 21.1878 10.4955L15.3545 13.7728C13.2701 14.9439 10.7299 14.9439 8.64545 13.7728L2.81218 10.4955Z" />
          </svg>
        </StyleUserInterfaceBar>
      </StyleUserInterfaceWrapperBar>
    );
      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="M17.6097 15.8068C17.6097 14.4868 18.6798 13.4167 19.9998 13.4167C21.3199 13.4167 22.39 14.4868 22.39 15.8068V29.7477C22.39 31.0677 21.3199 32.1378 19.9998 32.1378C18.6798 32.1378 17.6097 31.0677 17.6097 29.7477V15.8068Z"
              fill="white"
            />
            <path
              d="M24.0359 15.8987C24.0359 14.5279 25.1472 13.4167 26.518 13.4167C27.8888 13.4167 29 14.5279 29 15.8987V29.6558C29 31.0266 27.8888 32.1378 26.518 32.1378C25.1472 32.1378 24.0359 31.0266 24.0359 29.6558V15.8987Z"
              fill="white"
            />
            <path
              d="M11 10.3441C11 8.97331 12.1112 7.86206 13.482 7.86206C14.8528 7.86206 15.9641 8.97331 15.9641 10.3441V29.6558C15.9641 31.0266 14.8528 32.1378 13.482 32.1378C12.1112 32.1378 11 31.0266 11 29.6558V10.3441Z"
              fill="white"
            />
          </svg>
        </StyleUserInterfaceIcon>
